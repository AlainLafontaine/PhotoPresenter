...
class ViewSetting2: ObservableObject, Codable, Hashable {
    ...
    required init(from decoder: Decoder) throws {
        ...
        presenterDataSource = try container.decode(PhotoPresenterDataSource.self, forKey: .presenterDataSource)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(presenterDataSource, forKey: .presenterDataSource)
    ...
    static func == (lhs: ViewSetting2, rhs: ViewSetting2) -> Bool {
        return lhs.presenterDataSource == rhs.presenterDataSource &&
